...
class HrEmployee(models.Model):
    ...
    joining_date = fields.Date(string='Global Join Date', help="Employee  Global joining date computed from the contract start date", store=True)
    present_joining_date = fields.Date(string='Present Join Date', store=True)
    oe_id_issue_date = fields.Date(string='Emirates ID Issue Date', help='Issue date of Identification ID')
    id_expiry_date = fields.Date(string='Emirates ID Expiry Date', help='Expiry date of Identification ID')
    oe_unique_id = fields.Char(string="UID")
    visa_file_no = fields.Char(string="Visa File No.")
    visa_issue_date = fields.Date(string='Visa Issue Date')
    visa_expiry_date = fields.Date(string='Visa Issue Date')
    passport_issue_date = fields.Date(string='Passport Issue Date', help='Issue date of Passport ID')
    ...
    identification_id = fields.Char('Emirates ID', groups="hr.group_hr_user", tracking=True)
