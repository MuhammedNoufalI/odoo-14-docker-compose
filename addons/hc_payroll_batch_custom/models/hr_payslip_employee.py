...
class HrPayslipEmployees(models.TransientModel):
    ...
    def _get_available_contracts_domain(self):
        return [('contract_ids.state', 'in', ('open', 'close','probation')), ('company_id', '=', self.env.company.id)]


    #overrided from base functionality to add the contracts in the probation state
    def compute_sheet(self):
        ...
        contracts = employees._get_contracts(
            payslip_run.date_start, payslip_run.date_end, states=['open', 'close', 'probation']
